...
#######################################
Data1 = np.array(data[7], dtype=float)
Data2 = np.array(data[8], dtype=float)
Data3 = np.array(data[9], dtype=float)
Data4 = np.array(data[10], dtype=float)
