...
#######################################
Data1 = np.array(data[3], dtype=float)
Data2 = np.array(data[4], dtype=float)
Data3 = np.array(data[5], dtype=float)
Data4 = np.array(data[6], dtype=float)
...
for i in range(len(Data1)):
    ...
    vspprime.append((m1*v1prime[i]+m2*v2prime[i])/(m1+m2))
